...
for i in range(no_of_trees):
    trees_1_img.append(pygame.image.load('tree (1).png'))
    if i < 2:
...
no_of_trees = 4
for i in range(no_of_trees):
    trees_2_img.append(pygame.image.load('tree (1).png'))
    if i < 2:
...
no_of_trees = 4
for i in range(no_of_trees):
    trees_3_img.append(pygame.image.load('tree (1).png'))
    if i < 2:
...
no_of_trees = 4
for i in range(no_of_trees):
    trees_4_img.append(pygame.image.load('tree (1).png'))
    if i < 2:
...
no_of_trees = 4
for i in range(no_of_trees):
    trees_5_img.append(pygame.image.load('tree (1).png'))
    if i <= 2:
